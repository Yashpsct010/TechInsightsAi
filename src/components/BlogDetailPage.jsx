    ...
    return (
        ...
        >
            ...
            {loading ? (
                ...
                >
                    <motion.h1
                        className="text-2xl sm:text-3xl lg:text-4xl font-bold px-4 sm:px-6 pt-6 pb-3"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    <motion.div
                        className="px-4 sm:px-6 pb-4 text-sm text-gray-500 flex flex-wrap gap-2 sm:gap-4"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    >
                        ...
                        />
                        {blog.imageCaption && (
                            <p className="text-sm text-center text-gray-500 italic mt-2 px-4 sm:px-6">{blog.imageCaption}</p>
                        )}
                    </motion.div>

                    <motion.div
                        className="blog-content px-4 sm:px-6 pb-6 prose prose-sm sm:prose-base lg:prose-lg max-w-none"
                    ...
                    {blog.links && blog.links.length > 0 && (
                        <motion.div
                            className="px-4 sm:px-6 py-6 bg-gray-50 border-t border-gray-100"
                    ...
                    <motion.div
                        className="px-4 sm:px-6 py-6 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.8 }}
                    >
                        <div className="mb-4 sm:mb-0">
                            <h4 className="text-sm font-medium text-gray-500 mb-2">Share this post:</h4>
                ...
                <div className="text-center py-16">
                    <h3 className="text-xl font-medium mb-2">Blog not found</h3>
