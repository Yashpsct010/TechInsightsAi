...
const Home = () => {
    ...
    return (
        <motion.div
            ...
            className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50 pt-24 md:pt-28" // Added padding top for header
        >
            {/* Hero Section */}
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <motion.div
                        ...
                        className="absolute top-20 -right-24 w-96 h-96 bg-blue-400 rounded-full filter blur-3xl opacity-20"
                    />
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 0.6 }}
                        transition={{ delay: 0.8, duration: 1.5 }}
                        className="absolute -bottom-32 -left-32 w-96 h-96 bg-indigo-500 rounded-full filter blur-3xl opacity-20"
                    />
                </div>

                {/* Hero Content */}
                <div className="container mx-auto px-4 py-16 relative z-10"> {/* Adjusted padding top */}
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <motion.h1
                            ...
                            className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-transparent bg-clip-text"
                        >
                        ...
                        >
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Link
                                    to="/blog"
                                    className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-medium py-4 px-8 rounded-lg shadow-lg hover:shadow-blue-200/50 transition-all duration-300 flex items-center gap-2"
                                >
                            ...
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Link
                                    to="/about"
                                    className="bg-white text-gray-800 font-medium py-4 px-8 rounded-lg shadow-md hover:shadow-lg border border-gray-100 transition-all duration-300 flex items-center gap-2"
                                >
                                    Learn More
                                </Link>
                            </motion.div>
            ...
            <div className="container mx-auto px-4 py-20">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">Our platform leverages the power of artificial intelligence to bring you the most relevant and cutting-edge tech content.</p>
                </motion.div>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-r from-blue-600 to-indigo-700 py-16 mt-20"
            >
                <div className="container mx-auto px-4 text-center">
                    ...
                    >
                        <Link
                            to="/blog"
                            className="inline-block bg-white text-blue-700 font-medium py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                            Start Reading Now
                        </Link>
                    </motion.div>
