    ...
    return (
        <motion.header
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled
                    ? 'bg-gradient-to-r from-blue-900/95 via-blue-800/95 to-indigo-800/95 backdrop-blur-sm shadow-lg py-3'
                    : 'bg-gradient-to-r from-blue-800 to-indigo-700 py-5'
                }`}
            initial={{ y: -100 }}
            animate={{ y: 0 }}
                ...
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center space-x-1">
                        {navItems.map((item, index) => (
                            ...
                            >
                                <NavLink
                                    to={item.path}
                                    className={({ isActive }) => `
                                        relative px-5 py-2 rounded-md text-sm font-medium 
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="ml-4 bg-white text-blue-700 px-5 py-2 rounded-full font-medium text-sm shadow hover:shadow-lg hover:bg-blue-50 transition-all"
                        >
                            Subscribe
                        </motion.button>
                    </nav>
                        ...
                        <div className="flex flex-col h-full pt-20 px-6">
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    className="pt-6"
                                >
                                    <button className="w-full bg-white text-blue-700 py-4 px-4 rounded-xl font-medium shadow-lg text-center">
                                        Subscribe
                                    </button>
                                </motion.div>
                            </motion.nav>
